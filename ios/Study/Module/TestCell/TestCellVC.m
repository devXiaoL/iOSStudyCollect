...
@interface TestCellVC ()<UITableViewDelegate, UITableViewDataSource>
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(nonnull NSIndexPath *)indexPath{
    ...
    return [PhotoViews sizeWithImageCount:photos.count].height + 20;
}
...
- (NSArray *)pictureUrls{
    ...
    return @[arr1,arr2,arr3,arr2,arr3,arr1,arr3,arr1,arr2,arr3,arr2,arr1];
}
